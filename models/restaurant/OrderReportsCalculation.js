...
const orderReportCalculationSchema = new mongoose.Schema(
  {
...
const OrderReportCalculation = mongoose.model(
  "OrderReportCalculation",
  orderReportCalculationSchema
);

module.exports = OrderReportCalculation;
